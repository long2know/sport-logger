...
- **Current stack:** Legacy Java Android/Wear OS project with `mobile`, `wear`, and `utilities` modules
- **Target:** Current tooling, modular architecture, full device-supported measurement capture, polished UI, reliable sync, Health Connect, Endurain, and connectors

## Core Context

Scribe owns session logs, decision merging, and cross-agent context propagation.
