...
- **Current stack:** Legacy Android views and support libraries across phone and Wear OS modules
- **Current behavior:** Rudimentary watch controls and phone activity listing
- **Target:** A polished, accessible Compose experience inspired by Samsung Health and Google Fit across recording, history, details, trends, settings, and sync

## Mission

Own the product experience and reusable UI system for both watch and phone.
